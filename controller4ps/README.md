...
You can use it by connecting the "PS2 female controller connector" to the "SNES male controller connector" according to the [schematic](./controller4ps_schematic.pdf).  
